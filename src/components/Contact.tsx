...
const partnerLinks: Record<string, string> = {
  'Maha Bar': 'https://mahabar.com/',
  'Bazita': 'https://bazitakorcula.com/',
};
  ...
  return (
    <section id="contact" style={{ background: '#EFEFEA', padding: 'clamp(5rem,10vw,9rem) 0 0' }}>
      <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 clamp(1.5rem,5vw,4rem)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1fr]" style={{ gap: 'clamp(3rem,7vw,5rem)', maxWidth: '960px', margin: '0 auto' }}>
          ...
          {/* Right — contact info + partners + reserve */}
          <div>
            <Reveal delay={100}>
