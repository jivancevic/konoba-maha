      ...
      sections: [
        {
          ...
          items: [
            { name: "Vrtna Salata", price: "10,00 €", tags: ["vegetarian"] },
            {
        ...
        },
        {
          ...
          items: [
            ...
            { name: "Riba", desc: "Dnevni Ulov", price: "99,00 € / kg" },
          ],
        },
        {
          id: "desserts",
...
export function getHighlights(lang: Language): HighlightItem[] {
  ...
  return [
    ...
    { name: isEN ? "Grandma's Makaruni" : 'Makaruni u Babinoj Salsi', desc: isEN ? 'Hand-rolled pasta, tomato salsa, young goat cheese, basil' : 'Ručno valjana tjestenina, umak od rajčice, mladi kozji sir', price: '25,00 €', tag: isEN ? 'Warm Starter' : 'Toplo Predjelo' },
    { name: isEN ? 'Grilled Octopus' : 'Grill Hobotnica', desc: isEN ? 'Black beans, zucchini, potatoes, chimichurri' : 'Crni grah, tikvice, krumpir, chimichurri', price: '38,00 €', tag: isEN ? 'Main Course' : 'Glavno Jelo' },
    { name: isEN ? 'Lamb Peka' : 'Peka Janjetina', desc: isEN ? 'Slow-roasted, rosemary, root vegetables — 24h pre-order' : 'Polako pečena, ružmarin, korjenasto povrće — 24h narudžba', price: '45,00 €', tag: isEN ? '✦ Signature' : '✦ Specijalitet' },
    { name: isEN ? 'Dry-Aged Rib Eye (21 Days)' : 'Rib Eye Steak (Odležan 21 Dan)', desc: isEN ? 'Crispy potatoes, seasonal vegetables' : 'Hrskavi krumpir, sezonsko povrće', price: '45,00 €', tag: isEN ? 'Main Course' : 'Glavno Jelo' },
    { name: isEN ? 'Traditional Sweets of Korčula' : 'Tradicionalni Korčulanski Kolačići', desc: '', price: '9,00 €', tag: isEN ? 'Dessert' : 'Desert' },
  ];
}
